...
def prepare_dirs_and_logger(config):
    ...
    if config.text_model_path:
        config.text_model_path = os.path.join(config.log_dir, config.text_model_path)
        config.text_model_path = os.path.join(config.text_model_path, 'model')
    ...
    if config.load_path:
        ...
        model_name = os.path.join(config.dataset, get_time())
    else:
        model_name = os.path.join(config.dataset, get_time())    
